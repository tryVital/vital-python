...
def test_sleep_returns_data(test_client: Client, user_id: str, start_date, end_date):
    data = test_client.Sleep.get(user_id, start_date, end_date)
...
def test_sleep_returns_data_for_provider(
    ...
    data = test_client.Sleep.get(user_id, start_date, end_date, provider)
