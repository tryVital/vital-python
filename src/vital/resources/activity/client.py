        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            urllib.parse.urljoin(
                f"{self._client_wrapper.get_base_url()}/", f"v2/summary/activity/{jsonable_encoder(user_id)}"
            ),
    ...
    def get_raw(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            "GET",
            urllib.parse.urljoin(
                f"{self._client_wrapper.get_base_url()}/", f"v2/summary/activity/{jsonable_encoder(user_id)}/raw"
            ),
            params=jsonable_encoder(
                remove_none_from_dict(
                    {
