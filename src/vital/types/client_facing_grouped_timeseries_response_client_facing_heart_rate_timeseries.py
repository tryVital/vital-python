...
class ClientFacingGroupedTimeseriesResponseClientFacingHeartRateTimeseries(pydantic.BaseModel):
    groups: typing.Dict[str, typing.List[ClientFacingTimeseriesGroupClientFacingHeartRateTimeseries]] = pydantic.Field(
