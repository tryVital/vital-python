...
class ClientFacingGroupedTimeseriesResponseClientFacingBloodOxygenTimeseries(pydantic.BaseModel):
    groups: typing.Dict[
        str, typing.List[ClientFacingTimeseriesGroupClientFacingBloodOxygenTimeseries]
