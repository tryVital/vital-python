...
class GroupedFallResponse(UniversalBaseModel):
    groups: typing.Dict[
        str, typing.List[VitalCoreSchemasResponseSchemasTimeseriesClientFacingTimeseriesGroupClientFacingFallSample]
    ] = pydantic.Field()
    """
