...
class GroupedDistanceResponse(UniversalBaseModel):
    groups: typing.Dict[
        str,
        typing.List[VitalCoreSchemasResponseSchemasTimeseriesClientFacingTimeseriesGroupClientFacingDistanceTimeseries],
    ] = pydantic.Field()
    """
