...
class ClientFacingGroupedTimeseriesResponseClientFacingElectrocardiogramVoltageTimeseries(pydantic.BaseModel):
    groups: typing.Dict[
        str, typing.List[ClientFacingTimeseriesGroupClientFacingElectrocardiogramVoltageTimeseries]
