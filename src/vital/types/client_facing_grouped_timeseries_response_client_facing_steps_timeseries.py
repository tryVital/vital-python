...
class ClientFacingGroupedTimeseriesResponseClientFacingStepsTimeseries(pydantic.BaseModel):
    groups: typing.Dict[str, typing.List[ClientFacingTimeseriesGroupClientFacingStepsTimeseries]] = pydantic.Field(
