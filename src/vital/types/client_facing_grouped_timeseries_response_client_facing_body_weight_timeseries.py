...
class ClientFacingGroupedTimeseriesResponseClientFacingBodyWeightTimeseries(pydantic.BaseModel):
    groups: typing.Dict[str, typing.List[ClientFacingTimeseriesGroupClientFacingBodyWeightTimeseries]] = pydantic.Field(
