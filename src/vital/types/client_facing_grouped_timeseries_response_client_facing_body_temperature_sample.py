...
class ClientFacingGroupedTimeseriesResponseClientFacingBodyTemperatureSample(UniversalBaseModel):
    groups: typing.Dict[str, typing.List[ClientFacingTimeseriesGroupClientFacingBodyTemperatureSample]] = (
        pydantic.Field()
    )
    """
