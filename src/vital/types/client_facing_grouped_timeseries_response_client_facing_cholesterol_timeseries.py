...
class ClientFacingGroupedTimeseriesResponseClientFacingCholesterolTimeseries(pydantic.BaseModel):
    groups: typing.Dict[
        str, typing.List[ClientFacingTimeseriesGroupClientFacingCholesterolTimeseries]
