...
class ClientFacingGroupedTimeseriesResponseClientFacingCaloriesBasalTimeseries(pydantic.BaseModel):
    groups: typing.Dict[
        str, typing.List[ClientFacingTimeseriesGroupClientFacingCaloriesBasalTimeseries]
