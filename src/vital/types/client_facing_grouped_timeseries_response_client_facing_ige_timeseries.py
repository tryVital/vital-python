...
class ClientFacingGroupedTimeseriesResponseClientFacingIgeTimeseries(pydantic.BaseModel):
    groups: typing.Dict[str, typing.List[ClientFacingTimeseriesGroupClientFacingIgeTimeseries]] = pydantic.Field(
