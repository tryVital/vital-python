...
class ClientFacingGroupedTimeseriesResponseClientFacingHeartRateAlertSample(UniversalBaseModel):
    groups: typing.Dict[str, typing.List[ClientFacingTimeseriesGroupClientFacingHeartRateAlertSample]] = (
        pydantic.Field()
    )
    """
