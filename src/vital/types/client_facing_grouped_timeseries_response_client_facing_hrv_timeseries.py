...
class ClientFacingGroupedTimeseriesResponseClientFacingHrvTimeseries(pydantic.BaseModel):
    groups: typing.Dict[str, typing.List[ClientFacingTimeseriesGroupClientFacingHrvTimeseries]] = pydantic.Field(
