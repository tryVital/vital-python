...
class ClientFacingGroupedTimeseriesResponseClientFacingCaffeineTimeseries(pydantic.BaseModel):
    groups: typing.Dict[str, typing.List[ClientFacingTimeseriesGroupClientFacingCaffeineTimeseries]] = pydantic.Field(
