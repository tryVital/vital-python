...
class ClientFacingGroupedTimeseriesResponseClientFacingRespiratoryRateTimeseries(pydantic.BaseModel):
    groups: typing.Dict[
        str, typing.List[ClientFacingTimeseriesGroupClientFacingRespiratoryRateTimeseries]
