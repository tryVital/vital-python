...
class ClientFacingGroupedTimeseriesResponseClientFacingMindfulnessMinutesTimeseries(pydantic.BaseModel):
    groups: typing.Dict[
        str, typing.List[ClientFacingTimeseriesGroupClientFacingMindfulnessMinutesTimeseries]
