...
class GroupedWaterResponse(UniversalBaseModel):
    groups: typing.Dict[
        str,
        typing.List[VitalCoreSchemasResponseSchemasTimeseriesClientFacingTimeseriesGroupClientFacingWaterTimeseries],
    ] = pydantic.Field()
    """
