...
class ClientFacingElectrocardiogramSourceType(enum.StrEnum):
    """
    ...
    def visit(
        ...
        if self is ClientFacingElectrocardiogramSourceType.LAB:
            return lab()
        if self is ClientFacingElectrocardiogramSourceType.EXERCISE_MACHINE:
            return exercise_machine()
        if self is ClientFacingElectrocardiogramSourceType.EARPHONE:
            return earphone()
