...
class ClientFacingHeartrateChangedEventType(enum.StrEnum):
    DAILY_DATA_HEARTRATE_CREATED = "daily.data.heartrate.created"
    DAILY_DATA_HEARTRATE_UPDATED = "daily.data.heartrate.updated"
    _UNKNOWN = "__CLIENTFACINGHEARTRATECHANGEDEVENTTYPE_UNKNOWN__"
    """
    This member is used for forward compatibility. If the value is not recognized by the enum, it will be stored here, and the raw value is accessible through `.value`.
    """

    @classmethod
    def _missing_(cls, value: typing.Any) -> "ClientFacingHeartrateChangedEventType":
