...
class ClientFacingGroupedTimeseriesResponseClientFacingCaloriesActiveTimeseries(pydantic.BaseModel):
    groups: typing.Dict[
        str, typing.List[ClientFacingTimeseriesGroupClientFacingCaloriesActiveTimeseries]
