...
class ClientFacingGroupedTimeseriesResponseClientFacingWaterTimeseries(pydantic.BaseModel):
    groups: typing.Dict[str, typing.List[ClientFacingTimeseriesGroupClientFacingWaterTimeseries]] = pydantic.Field(
