...
class ClientFacingGroupedTimeseriesResponseClientFacingWorkoutDurationSample(UniversalBaseModel):
    groups: typing.Dict[str, typing.List[ClientFacingTimeseriesGroupClientFacingWorkoutDurationSample]] = (
        pydantic.Field()
    )
    """
