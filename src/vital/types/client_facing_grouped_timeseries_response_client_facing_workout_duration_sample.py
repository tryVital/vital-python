...
class ClientFacingGroupedTimeseriesResponseClientFacingWorkoutDurationSample(pydantic.BaseModel):
    groups: typing.Dict[
        str, typing.List[ClientFacingTimeseriesGroupClientFacingWorkoutDurationSample]
