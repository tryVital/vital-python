...
class ClientFacingGroupedTimeseriesResponseClientFacingCarbohydratesSample(UniversalBaseModel):
    groups: typing.Dict[str, typing.List[ClientFacingTimeseriesGroupClientFacingCarbohydratesSample]] = pydantic.Field()
    """
