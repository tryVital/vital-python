...
class ClientFacingGroupedTimeseriesResponseClientFacingBodyFatTimeseries(pydantic.BaseModel):
    groups: typing.Dict[str, typing.List[ClientFacingTimeseriesGroupClientFacingBodyFatTimeseries]] = pydantic.Field(
