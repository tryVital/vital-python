...
class ClientFacingGroupedTimeseriesResponseClientFacingIggTimeseries(pydantic.BaseModel):
    groups: typing.Dict[str, typing.List[ClientFacingTimeseriesGroupClientFacingIggTimeseries]] = pydantic.Field(
