...
class UserClient:
    ...
    def create(
        ...
        *,
        ...
        fallback_birth_date: typing.Optional[dt.date] = OMIT,
        ingestion_start: typing.Optional[dt.date] = OMIT,
        ingestion_end: typing.Optional[dt.date] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> ClientFacingUserKey:
        """
...
class AsyncUserClient:
    ...
    async def upsert_user_info(
        ...
        *,
        ...
        client = AsyncVital(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.user.upsert_user_info(user_id='user_id', first_name='first_name', last_name='last_name', email='email', phone_number='phone_number', gender='gender', dob=datetime.date.fromisoformat("2023-01-15", ), address=Address(first_line='first_line', country='country', zip='zip', city='city', state='state', ), )
        asyncio.run(main())
        """
    ...
    async def create_portal_url(
        ...
        *,
        ...
        client = AsyncVital(api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.user.create_portal_url(user_id='user_id', context=CreateUserPortalUrlBodyContext.LAUNCH, )
        asyncio.run(main())
        """
